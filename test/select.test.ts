...
var linqData: Array<{ name: string, age: number, workPlace: string, gender: "male" | "female", IsDead: boolean, birthdate: Date }> = [];
// 1220 year
...
describe("pow", function () {
    ...
    it("Select names", function () {
        console.log(JSON.stringify(linqData.Select(x => x.name)));
